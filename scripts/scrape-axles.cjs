...
const MONDOKART_URL = 'https://www.mondokart.com/it/assali-mondokart/';
...
(async () => {
  console.log('🚀 Starting Axles scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} axle products\n`);
  ...
  const outputPath = path.join(__dirname, 'axles-data.json');

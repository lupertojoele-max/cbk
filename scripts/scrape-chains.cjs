...
const MONDOKART_URL = 'https://www.mondokart.com/it/catene-kf-60cc-passo-219-mondokart/';
...
async function scrapeProducts() {
  console.log('🚀 Starting Mondokart Chains scraper...\n');
  ...
  try {
    ...
    // Save data
    const outputPath = path.join(__dirname, 'chains-data.json');
...
scrapeProducts().then(products => {
  console.log(`\n🎉 Scraping completed! ${products.length} chains found.`);
}).catch(error => {

...
const MONDOKART_URL = 'https://www.mondokart.com/it/per-kf-kz-assale-50mm-mondokart/';
...
(async () => {
  console.log('🚀 Starting Rear Hubs 50mm (KF/KZ) scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} rear hub 50mm products\n`);
  ...
  const outputPath = path.join(__dirname, 'rear-hubs-50mm-data.json');

...
const MONDOKART_URL = 'https://www.mondokart.com/it/mozzi-per-kz-campana-40mm-mondokart/';
...
(async () => {
  console.log('🚀 Starting Hubs KZ 40mm scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} hub KZ 40mm products\n`);
  ...
  const outputPath = path.join(__dirname, 'hubs-kz-40mm-data.json');

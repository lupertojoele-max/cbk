...
const MONDOKART_URL = 'https://www.mondokart.com/it/per-minikart-assale-30mm-mondokart/';
...
(async () => {
  console.log('🚀 Starting Rear Hubs 30mm (Mini) scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} rear hub 30mm products\n`);
  ...
  const outputPath = path.join(__dirname, 'rear-hubs-30mm-data.json');

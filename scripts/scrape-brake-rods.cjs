...
const MONDOKART_URL = 'https://www.mondokart.com/it/tiranti-freno-mondokart/';
...
async function scrapeProducts() {
  console.log('🚀 Starting Puppeteer scraper for brake rods...\n');
  ...
  try {
    ...
    await page.screenshot({ path: 'mondokart-brake-rods.png', fullPage: false });
    console.log('📸 Screenshot saved as mondokart-brake-rods.png');
    ...
    fs.writeFileSync(
      path.join(__dirname, 'brake-rods-data.json'),
      JSON.stringify(productsData, null, 2)
    );
    console.log('💾 Saved product data to brake-rods-data.json\n');

...
const MONDOKART_URL = 'https://www.mondokart.com/it/set-cerchi-magnesio-4pz/';
...
(async () => {
  console.log('🚀 Starting Magnesium Wheel Sets scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} magnesium wheel set products\n`);
  ...
  // Save to JSON
  const outputPath = path.join(__dirname, 'magnesium-wheel-sets-data.json');

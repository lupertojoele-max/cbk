...
const MONDOKART_URL = 'https://www.mondokart.com/it/mozzi-con-cuscinetti-da-17mm-mondokart/';
...
(async () => {
  console.log('🚀 Starting Hubs 17mm scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} hub 17mm products\n`);
  ...
  const outputPath = path.join(__dirname, 'hubs-17mm-data.json');

/**
 * Scraper per VOLANTI e ACCESSORI da mondokart.com
 */
...
const SUBCATEGORIES = [
  'https://www.mondokart.com/it/volanti-mondokart/',
  'https://www.mondokart.com/it/mozzi-per-volanti-mondokart/',
  'https://www.mondokart.com/it/accessori-per-volanti-mondokart/',
];

const ID_PREFIX = 'mk-volante';
const OUTPUT_FILE = 'steering-wheels-data.json';
...
async function scrapeProducts() {
  console.log('🚀 Starting Volanti scraper...\n');

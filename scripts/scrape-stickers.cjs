/**
 * Scraper per ADESIVI da mondokart.com
 */
...
const SUBCATEGORIES = [
  'https://www.mondokart.com/it/numeri-e-tabelle-adesive-mondokart/',
  'https://www.mondokart.com/it/adesivi-carenature-mondokart/',
  'https://www.mondokart.com/it/adesivi-serbatoio-mondokart/',
  'https://www.mondokart.com/it/nastri-adesivi-mondokart/',
  'https://www.mondokart.com/it/adesivi-generici-mondokart/',
];

const ID_PREFIX = 'mk-adesivo';
const OUTPUT_FILE = 'stickers-data.json';
...
async function scrapeProducts() {
  console.log('🚀 Starting Adesivi scraper...\n');
  ...
  try {
    ...
    console.log(`💾 Saved: ${processedProducts.length} adesivi`);
    await browser.close();

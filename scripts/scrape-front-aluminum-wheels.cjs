...
const MONDOKART_URL = 'https://www.mondokart.com/it/cerchi-anteriori-alluminio-mondokart/';
...
(async () => {
  console.log('🚀 Starting Front Aluminum Wheels scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} front aluminum wheel products\n`);
  ...
  // Save to JSON
  const outputPath = path.join(__dirname, 'front-aluminum-wheels-data.json');

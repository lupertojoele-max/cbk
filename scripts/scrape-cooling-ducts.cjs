...
const MONDOKART_URL = 'https://www.mondokart.com/it/convogliatori-raffreddamento-mondokart/';
...
(async () => {
  console.log('🚀 Starting Cooling Ducts scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} cooling duct products\n`);
  ...
  // Save to JSON
  const outputPath = path.join(__dirname, 'cooling-ducts-data.json');

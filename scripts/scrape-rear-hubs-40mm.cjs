...
const MONDOKART_URL = 'https://www.mondokart.com/it/per-kf-kz-assale-40mm-mondokart/';
...
(async () => {
  console.log('🚀 Starting Rear Hubs 40mm (KF/KZ) scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} rear hub 40mm products\n`);
  ...
  const outputPath = path.join(__dirname, 'rear-hubs-40mm-data.json');

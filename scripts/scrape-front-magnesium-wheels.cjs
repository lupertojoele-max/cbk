...
const MONDOKART_URL = 'https://www.mondokart.com/it/cerchi-anteriori-magnesio-mondokart/';
...
(async () => {
  console.log('🚀 Starting Front Magnesium Wheels scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} front magnesium wheel products\n`);
  ...
  // Save to JSON
  const outputPath = path.join(__dirname, 'front-magnesium-wheels-data.json');

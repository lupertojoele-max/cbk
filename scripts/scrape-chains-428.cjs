...
const MONDOKART_URL = 'https://www.mondokart.com/it/catene-kz-125cc-passo-428-mondokart/';
...
async function scrapeProducts() {
  console.log('🚀 Starting Mondokart Chains 428 scraper...\n');
  ...
  try {
    ...
    // Save data
    const outputPath = path.join(__dirname, 'chains-428-data.json');
...
scrapeProducts().then(products => {
  console.log(`\n🎉 Scraping completed! ${products.length} chains 428 found.`);
}).catch(error => {

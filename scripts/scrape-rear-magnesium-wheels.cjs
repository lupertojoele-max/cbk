...
const MONDOKART_URL = 'https://www.mondokart.com/it/cerchi-posteriori-magnesio-mondokart/';
...
(async () => {
  console.log('🚀 Starting Rear Magnesium Wheels scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} rear magnesium wheel products\n`);
  ...
  // Save to JSON
  const outputPath = path.join(__dirname, 'rear-magnesium-wheels-data.json');

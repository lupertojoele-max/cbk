...
const MONDOKART_URL = 'https://www.mondokart.com/it/viti-spurgo-freno-mondokart/';
...
(async () => {
  console.log('🚀 Starting Bleed Screws scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} bleed screw products\n`);
  ...
  // Save to JSON
  const outputPath = path.join(__dirname, 'bleed-screws-data.json');

...
const MONDOKART_URL = 'https://www.mondokart.com/it/accessori-per-mozzi-ruota-mondokart/';
...
(async () => {
  console.log('🚀 Starting Hub Accessories scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} hub accessory products\n`);
  ...
  const outputPath = path.join(__dirname, 'hub-accessories-data.json');

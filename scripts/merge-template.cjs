/**
 * TEMPLATE MERGE MONDOKART
 *
 * Per usarlo:
 * 1. Copia questo file con un nuovo nome (es: merge-CATEGORIA.cjs)
 * 2. Modifica DATA_FILE con il nome del file JSON dallo scraper
 * 3. Modifica CATEGORY con la categoria prodotti
 * 4. Modifica DESCRIPTION_SUFFIX con la descrizione
 * 5. Esegui: node merge-CATEGORIA.cjs
 */
...
// ==================== CONFIGURAZIONE ====================
const DATA_FILE = 'categoria-data.json';  // File generato dallo scraper
const CATEGORY = 'categoria-prodotti';     // Categoria nel products.json
const DESCRIPTION_SUFFIX = 'Prodotto per kart';  // Suffisso descrizione
// ========================================================

...
const MONDOKART_URL = 'https://www.mondokart.com/it/mozzi-con-cuscinetti-da-25mm-mondokart/';
...
(async () => {
  console.log('🚀 Starting Hubs 25mm scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} hub 25mm products\n`);
  ...
  const outputPath = path.join(__dirname, 'hubs-25mm-data.json');

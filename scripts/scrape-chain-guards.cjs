...
const MONDOKART_URL = 'https://www.mondokart.com/it/paracatena-mondokart/';
...
async function scrapeProducts() {
  console.log('🚀 Starting Mondokart Chain Guards scraper...\n');
  ...
  try {
    ...
    // Save data
    const outputPath = path.join(__dirname, 'chain-guards-data.json');
...
scrapeProducts().then(products => {
  console.log(`\n🎉 Scraping completed! ${products.length} chain guards found.`);
}).catch(error => {

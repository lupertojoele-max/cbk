...
const MONDOKART_URL = 'https://www.mondokart.com/it/gommini-singoli-mondokart/';
...
(async () => {
  console.log('🚀 Starting Rubber Grommets scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} rubber grommet products\n`);
  ...
  // Save to JSON
  const outputPath = path.join(__dirname, 'rubber-grommets-data.json');

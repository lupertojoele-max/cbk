...
const MONDOKART_URL = 'https://www.mondokart.com/it/cerchi-posteriori-alluminio-mondokart/';
...
(async () => {
  console.log('🚀 Starting Rear Aluminum Wheels scraper...\n');
  ...
  console.log(`\n✅ Found ${products.length} rear aluminum wheel products\n`);
  ...
  // Save to JSON
  const outputPath = path.join(__dirname, 'rear-aluminum-wheels-data.json');
